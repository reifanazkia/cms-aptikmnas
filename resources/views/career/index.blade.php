                ...
                <tbody>
                    @forelse ($careers as $index => $career)
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-2 text-center">{{ $careers->firstItem() + $index }}</td>
                            <td class="px-4 py-2 text-center">{{ $career->position_title }}</td>
                            <td class="px-4 py-2 text-center">{{ $career->lokasi }}</td>
                            <td class="px-4 py-2 text-center">{{ $career->job_type }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-4 py-4 text-center text-gray-500">Belum ada data career</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
