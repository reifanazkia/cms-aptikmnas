@extends('layouts.app', ['title' => 'Kategori Gallery'])
...
@section('content')
    ...
    <script>
        ...
        function openEditModal(id, name) {
            let url = '{{ route('category-gallery.update', ':id') }}';
        ...
        function confirmDelete(id, name) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (form) {
                        let url = '{{ route('category-gallery.destroy', ':id') }}';
                        url = url.replace(':id', id);
                        form.action = url;
                        form.submit();
                    }
        ...
        /**
         * Notifikasi sukses dari session (flash message)
         */
