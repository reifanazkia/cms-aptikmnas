...
<head>
    ...
    <title>Tambah Pengurus - Step 1</title>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="mb-0">Tambah Pengurus - Step 1 dari 3</h4>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('pengurus.create.step1.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('descroption') is-invalid @enderror"
                                               id="descroption" name="descroption" value="{{ old('descroption') }}" required>
                                        @error('descroption')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="category_daftar_id" class="form-label"> Daftar Pengurus DPD</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="category_pengurus_id" class="form-label"> Pengurus</label>
