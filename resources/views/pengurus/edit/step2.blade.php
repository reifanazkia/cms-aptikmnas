                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-md p-4">
                        ...
                        <div class="p-4 space-y-4">
                            <div>
                                <label for="title2" class="block mb-1 font-medium">Judul 2 <span
                                        class="text-red-500">*</span></label>
                                <input type="text" id="title2" name="title2"
                                    value="{{ old('title2', $pengurus->title2) }}"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-emerald-500 focus:border-emerald-500 @error('title2') border-red-500 @enderror"
                                    required>
                                @error('title2')
                            ...
                            <div>
                                <label for="description2" class="block mb-1 font-medium">Deskripsi 2 <span
                                        class="text-red-500">*</span></label>
                                <textarea id="description2" name="description2" rows="4" required
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-emerald-500 focus:border-emerald-500 @error('description2') border-red-500 @enderror">{{ old('description2', $pengurus->description2) }}</textarea>
                                @error('description2')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                <label for="image2" class="block mb-1 font-medium">Gambar 2</label>
                                @if ($pengurus->image2)
                                    <div class="mb-2">
                                ...
                                <input type="file" id="image2" name="image2" accept="image/*"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 @error('image2') border-red-500 @enderror">
                    ...
                    <div class="bg-white rounded-xl shadow-md p-4">
                        ...
                        <div class="p-4 space-y-4">
                            <div>
                                <label for="title3" class="block mb-1 font-medium">Judul 3 <span
                                        class="text-red-500">*</span></label>
                                <input type="text" id="title3" name="title3"
                                    value="{{ old('title3', $pengurus->title3) }}"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-emerald-500 focus:border-emerald-500 @error('title3') border-red-500 @enderror"
                                    required>
                                @error('title3')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                <label for="description3" class="block mb-1 font-medium">Deskripsi 3 <span
                                        class="text-red-500">*</span></label>
                                <textarea id="description3" name="description3" rows="4" required
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-emerald-500 focus:border-emerald-500 @error('description3') border-red-500 @enderror">{{ old('description3', $pengurus->description3) }}</textarea>
                                @error('description3')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                <label for="image3" class="block mb-1 font-medium">Gambar 3</label>
                                @if ($pengurus->image3)
                                    <div class="mb-2">
                                ...
                                <input type="file" id="image3" name="image3" accept="image/*"
                                    class="w-full border border-gray-300 rounded-lg px-3 py-2 @error('image3') border-red-500 @enderror">
                                <small class="text-gray-500 block text-xs mt-1">Format: JPEG, PNG, JPG, GIF. Maksimal 2MB.
                                    Kosongkan jika tidak ingin mengganti.</small>
                                @error('image3')
                                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
